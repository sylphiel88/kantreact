...
const UserC = props => {
    ...
    function checkAllUsers(){
        var bool = document.getElementById("allUsers").checked
    ...
    return (
        <div className={props.close && "flex-center-div"} onWheel={(e) => wheelHandler(e)}>
            ...
            {!props.close && <span class="allUsersT">Alle Nutzer auf dieser Seite<input type="checkbox" className="allUsersChkb" id="allUsers" onChange={checkAllUsers}></input></span>}
        </div>
    )
}
